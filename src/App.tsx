          ...
          {gameState === 'setup' && (
            ...
            >
              <div className="flex flex-col items-center justify-center mb-4 gap-4">
                <img src="https://res.cloudinary.com/antony12/image/upload/v1778232586/mskgeqtsbtqz7ueo7i49.png" className="h-14 md:h-14 object-contain" alt="CPS and Bose Logo" />
